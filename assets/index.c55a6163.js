...
<div id="footer"></div>
`;class k extends HTMLElement{constructor(){super();const e=document.createElement("template");e.innerHTML=_,this.appendChild(e.content.cloneNode(!0))}}customElements.define("app-component",k);var f=`<div class="landing">
  <h1>
...
`;class c extends HTMLElement{connectedCallback(){const e=Object.assign({},...Array.from(this.attributes,({name:t,value:s})=>({[t]:s})));this.innerHTML=b(this.innerHTML.toString().trim(),e)}}function b(n,e){const t={"&":"&amp;","<":"&lt;",">":"&gt;","(":"%28",")":"%29"},s=i=>i.toString().replace(/[&<>\(\)]/g,a=>t[a]||a),l=Object.keys(e),o=Object.values(e).map(s);return new Function(...l,`return \`${n}\``)(...o)}class g extends c{constructor(){super();const e=document.createElement("template");e.innerHTML=f,this.appendChild(e.content.cloneNode(!0))}}customElements.define("landing-component",g);var L=`<div class="skills">
...
`;class I extends c{constructor(){super();const e=document.createElement("template");e.innerHTML=z,this.appendChild(e.content.cloneNode(!0))}connectedCallback(){super.connectedCallback();const{id:e,percentage:t}=this.attributes,s=this.querySelector(`#${e.value}`);s.style["max-width"]=t.value}}customElements.define("skill-bar-component",I);var N=`<form
  id="contact-form"
  class="contact-form"
