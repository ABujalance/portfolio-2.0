...
`;class A extends a{constructor(){super();const e=document.createElement("template");e.innerHTML=N,this.appendChild(e.content.cloneNode(!0))}connectedCallback(){super.connectedCallback();const{id:e,percentage:t}=this.attributes,s=this.querySelector(`#${e.value}`);s.style["max-width"]=t.value}}customElements.define("skill-bar-component",A);var B=`<form
  id="contact-form"
  class="contact-form"
...
`;class R extends a{constructor(){super();const e=document.createElement("template");e.innerHTML=G,this.appendChild(e.content.cloneNode(!0))}}customElements.define("about-component",R);var K=`<div class="projects">
  <div class="projects__container">
    <project-component></project-component>
  </div>
</div>
`;class W extends a{constructor(){super();const e=document.createElement("template");e.innerHTML=K,this.appendChild(e.content.cloneNode(!0))}}customElements.define("projects-component",W);var Y=`<!-- <div class="project">Hey</div> -->
`;class X extends a{constructor(){super();const e=document.createElement("template");e.innerHTML=Y,this.appendChild(e.content.cloneNode(!0))}}customElements.define("project-component",X);
