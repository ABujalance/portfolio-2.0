...
`;class l extends HTMLElement{connectedCallback(){const e=Object.assign({},...Array.from(this.attributes,({name:t,value:s})=>({[t]:s})));this.innerHTML=y(this.innerHTML.toString().trim(),e)}}function y(n,e){const t={"&":"&amp;","<":"&lt;",">":"&gt;","(":"%28",")":"%29"},s=a=>a.toString().replace(/[&<>\(\)]/g,c=>t[c]||c),o=Object.keys(e),i=Object.values(e).map(s);return new Function(...o,`return \`${n}\``)(...i)}class C extends l{constructor(){super();const e=document.createElement("template");e.innerHTML=k,this.appendChild(e.content.cloneNode(!0))}}customElements.define("landing-component",C);var w=`<div class="skills">
