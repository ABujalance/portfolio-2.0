var h=Object.defineProperty;var f=(n,e,t)=>e in n?h(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var r=(n,e,t)=>(f(n,typeof e!="symbol"?e+"":e,t),t);const b=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function t(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerpolicy&&(i.referrerPolicy=o.referrerpolicy),o.crossorigin==="use-credentials"?i.credentials="include":o.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(o){if(o.ep)return;o.ep=!0;const i=t(o);fetch(o.href,i)}};b();var v=`<nav-component></nav-component>
<section id="landing">
...
`;class j extends a{constructor(){super();r(this,"onScroll",()=>{const t=document.getElementById("nav");window.scrollY<=window.innerHeight-200?t.classList.remove("show-nav"):t.classList.add("show-nav")});const t=document.createElement("template");t.innerHTML=z,this.appendChild(t.content.cloneNode(!0))}connectedCallback(){super.connectedCallback(),document.addEventListener("scroll",this.onScroll);const t=document.getElementById("nav-button"),s=document.getElementById("nav-list"),o=document.getElementById("nav-close"),i=document.getElementById("modal-background");t.addEventListener("click",l=>x(l,s)),o.addEventListener("click",l=>d(l,s)),i.addEventListener("click",l=>{d(l,s)})}}function x(n,e){n.stopPropagation(),n.preventDefault(),e.classList.contains("show")?m(e):M(e)}function d(n,e){n.stopPropagation(),n.preventDefault(),m(e)}function m(n){n.classList.remove("show"),document.body.classList.remove("modal")}function M(n){n.classList.add("show"),document.body.classList.add("modal")}customElements.define("nav-component",j);var H=`<div class="footer">
...
`;class Q extends a{constructor(){super();const e=document.createElement("template");e.innerHTML=X,this.appendChild(e.content.cloneNode(!0))}connectedCallback(){super.connectedCallback(),this.buildTags()}buildTags(){const{tags:e}=this.attributes,t=this.querySelector("#project-tags");e.value.split(",").forEach(s=>{const o=document.createElement("li");o.innerHTML=s,t.appendChild(o)})}}customElements.define("project-component",Q);var Z=`<div id="policy" class="policy font__size-ml">
  This site uses essential cookies to ensure you get the best experience <a href="#footer" class="font__size-m">Learn more</a>
  <button id="policy-button" class="policy__button font__size-ml">Got it</button>
</div>
